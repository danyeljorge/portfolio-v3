...
export default function Hero() {
  ...
  return (
    <section
      className="relative pt-8 pb-16 lg:pt-14 lg:pb-24 border-b border-brand-border overflow-hidden"
      data-purpose="hero-section"
      id="hero"
    >
      {/* Brutalist Watermark Backing */}
      <div
        className="absolute -right-16 top-10 select-none pointer-events-none text-zinc-900/60 font-black text-[180px] lg:text-[280px] leading-none z-0 tracking-tighter opacity-40 font-display"
        aria-hidden="true"
      >
        DEV
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex items-center justify-between pb-6 border-b border-brand-border/60 text-xs font-mono text-zinc-500 animate-hero-header">
          ...
          <div className="hidden sm:flex items-center gap-6 tracking-widest text-[11px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-end pt-8 lg:pt-12">
          ...
          >
            ...
            <div className="text-brand-neon text-2xl font-mono mb-4 flex items-center gap-2 animate-hero-header">
              ...
              <span className="text-xs font-mono text-zinc-400 uppercase tracking-widest">
                PORTFÓLIO EDITORIAL 2025 // V3.8
              </span>
            </div>

            {/* Big Brutalist Kinetic Typography */}
            <h1 className="font-display font-black text-4xl sm:text-6xl lg:text-[64px] xl:text-[76px] leading-[0.92] tracking-tighter uppercase mb-6 text-white animate-hero-headline">
              {personal.heroHeadline.line1}
              <br />
              <span className="text-white">{personal.heroHeadline.line2}</span>
              <br />
            ...
            <p className="font-heading text-lg sm:text-xl text-zinc-400 font-normal max-w-xl leading-relaxed mb-8 animate-hero-bio">
              {personal.shortBio}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2 animate-hero-cta">
              <Link
                href="#trabalhos"
                className="px-8 py-4 bg-brand-neon text-black font-mono font-extrabold text-sm tracking-wider uppercase hover:bg-white transition-all duration-300 shadow-[0_0_30px_rgba(0,255,102,0.35)] flex items-center gap-2 border border-brand-neon group"
              >
              ...
              <Link
                href="#contato"
                className="px-7 py-4 bg-brand-card hover:bg-brand-dark text-zinc-300 hover:text-white font-mono text-sm tracking-wider uppercase transition-all duration-300 border border-brand-border flex items-center gap-3 group"
              >
                <span className="w-2 h-2 rounded-full bg-brand-neon animate-pulse"></span>
                <span>CONTRATAR FREELANCE</span>
              </Link>
            </div>

            {/* Quick Tech Highlights */}
            <div className="mt-12 pt-8 border-t border-brand-border/80 flex flex-wrap items-center gap-8 font-mono text-xs text-zinc-400 animate-hero-highlights">
              <div className="flex items-center gap-2">
                <BoltIcon className="w-4 h-4 text-brand-neon" />
                <span className="text-white font-bold">100%</span> PageSpeed Score
              </div>
              <div className="flex items-center gap-2">
                <LayerIcon className="w-4 h-4 text-brand-neon" />
                <span className="text-white font-bold">5+ Anos</span> Experiência Web
              </div>
              <div className="flex items-center gap-2">
                <TerminalIcon className="w-4 h-4 text-brand-neon" />
                <span className="text-white font-bold">Next.js & React</span> Core Stack
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10 w-full max-w-[420px] lg:max-w-none">
              ...
              <div className="absolute top-2 -left-3 sm:-left-6 z-20 bg-brand-card/90 backdrop-blur-md border border-brand-neon px-3 py-2 text-[11px] font-mono text-white shadow-xl flex items-center gap-2.5">
                <div className="w-2 h-2 rounded-full bg-brand-neon"></div>
                <div>
                  <div className="font-bold text-brand-neon">DANIEL JORGE</div>
              ...
              <div className="absolute -bottom-4 right-0 sm:right-4 z-20 bg-brand-black border border-brand-border p-3.5 shadow-2xl font-mono text-xs">
                <div className="flex items-center gap-3">
                  <div className="bg-brand-neon/10 text-brand-neon p-2 text-lg">
              ...
              <div className="relative overflow-hidden border-b-4 border-brand-neon">
                <Image
                  src={danielPhoto}
                  alt="Daniel Jorge - Desenvolvedor Web Front-end & Full Stack"
